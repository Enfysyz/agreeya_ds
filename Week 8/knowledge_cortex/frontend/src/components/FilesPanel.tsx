...
export function FilesPanel({
  ...
  return (
    ...
    >
      {isOpen && (
        <div className="flex flex-col h-full animate-fade-in w-[380px]">
          {/* Header */}
              ...
              {isLoading ? (
                ...
                <div className="space-y-2 pb-6">
                  {files.map((file, index) => (
                    <Card
                      key={index}
                      className="border-border bg-card hover:bg-secondary/30 transition-all duration-200"
                    >
                      <CardContent className="p-3 flex items-center gap-3">
                        ...
                        <Badge
                          variant="secondary"
                          className="text-[10px] px-1.5 py-0 h-5 bg-emerald-500/15 text-emerald-600 border border-emerald-200 flex-shrink-0"
                        >
                          indexed
                        </Badge>
                      </CardContent>
